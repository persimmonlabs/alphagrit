...
export const pt: typeof en = {
  ...
  dashboard: {
    ...
    noSubscription: "Sem assinatura ativa. Assine para começar.",
    viewEbooks: "Ver Ebooks",
  ...
  ebooks: {
    ...
    readNow: "Ler Agora",
    buyNow: "Assinar Agora", // Atualizado para modelo de assinatura
    comingSoon: "Em breve",
    ...
    purchaseRequired: "Assinatura necessária", // Atualizado
    previous: "Anterior",
    next: "Próximo",
