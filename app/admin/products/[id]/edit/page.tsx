...
export default function EditProductPage() {
  ...
  useEffect(() => {
    ...
    if (foundProduct) {
      ...
      setFormData({
        titlePT: foundProduct.name,
        titleEN: foundProduct.name,
        descriptionPT: foundProduct.description_full || '',
        descriptionEN: foundProduct.description_full || '',
        priceBRL: foundProduct.price_brl.toString(),
        ...
        status: foundProduct.status as 'draft' | 'active',
      });
    }
  }, [productId]);
    ...
    <div className="flex h-screen bg-black text-white">
      ...
      <aside className="w-64 bg-neutral-900 border-r border-neutral-800">
        ...
        <nav className="mt-6">
          ...
          <Link href="/admin/ebooks" className="flex items-center px-6 py-3 hover:bg-neutral-800 transition-colors">
            <span className="text-xl">📚</span>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-400 mt-1 mb-2">
                    Current: {product.cover_image_url || 'No image'}
                  </p>
                  <Input
                    id="coverImage"
                    type="file"
