      ...
      <main className="container mx-auto p-4 md:p-8">
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-6 mb-6 md:mb-8">
          <Card className="bg-neutral-900 border-neutral-800">
            ...
            <CardContent className="p-3 pt-0 md:p-6 md:pt-0">
              <div className="text-xl md:text-3xl font-bold text-orange-500">{stats.totalSubscriptions}</div>
            </CardContent>
          </Card>
        ...
        <div className="grid gap-4 md:gap-6 md:grid-cols-2 lg:grid-cols-3 mb-6 md:mb-8">
          ...
          <Card className="bg-neutral-900 border-neutral-800">
            ...
            <CardContent>
              <p className="text-neutral-400 mb-4">
                Grant or revoke user access manually.
              </p>
              <Link
        ...
        <div className="grid gap-4 md:gap-8 lg:grid-cols-2">
          {/* Revenue Card - Subscriptions are the primary revenue source */}
          <Card className="bg-neutral-900 border-neutral-800">
            <CardHeader>
            ...
            <CardContent>
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mb-4">
                <p className="text-sm text-blue-400">
                  <strong>Subscription Model:</strong> Revenue comes from monthly ($15) and yearly ($120) subscriptions.
                  View detailed payment history in your Stripe Dashboard.
                </p>
              </div>
              <a
